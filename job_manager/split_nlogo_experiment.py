...
def spliter(nlogo_filename, experiment_name, ):
    ...
    aparser.add_argument("nlogo_file", default=nlogo_filename , help = "Netlogo .nlogo file with the original experiment")
    aparser.add_argument("experiment", default=experiment_name,nargs = "*", help = "Name of one or more experiments in the nlogo file to expand. If none are given, --all_experiments must be set.")
    ...
    aparser.add_argument("--output_dir", default=output_directory, help = "Path to output directory if not current directory.")
    ...
    argument_ns = aparser.parse_args([nlogo_filename, experiment_name, "--output_dir", output_directory])
